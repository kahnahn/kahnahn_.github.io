...
export const VOCABULARY_WORDS: VocabularyWord[] = [
  ...
  },
  {
    ...
    example: "Because he always wound up kicking himself in the head, Oswald began to abhor soccer."
  },
  {
    word: "abide",
    type: "v.",
  ...
  },
  {
    ...
    example: "After losing all her money, falling into a puddle, Eloise was abject."
  },
  {
    word: "abjure",
    type: "v.",
  ...
  },
  {
    ...
    example: "The holy man practiced abnegation, sleeping on the floor and taking only cold showers."
  },
  {
    word: "abort",
    type: "v.",
    definition: "to give up on a half-finished project or effort",
    example: "After they ran out of food, the men had to abort their attempt to jump rope around the world."
  },
  {
    word: "abridge",
    type: "v.",
  ...
  },
  {
    ...
    example: "The jury gave Angela absolution by giving a verdict of not guilty."
  },
  {
    word: "abstain",
    type: "v.",
  ...
  },
  {
    ...
    type: "v.",
    definition: "to agree",
    example: "When the class asked to play baseball, the teacher acceded to their request."
  },
  {
    word: "accentuate",
    type: "v.",
  ...
  },
   {
    ...
    example: "After studying, Marlena happily realized her goal of an Ivy-League college was accessible."
  },
  {
    word: "acclaim",
    type: "n.",
  ...
  },
  {
    ...
    example: "Though the apartment was not big, the friends were accommodating to each other."
  },
  {
    word: "accord",
    type: "n.",
    definition: "an agreement",
    example: "The two nations came to a mutually beneficial accord about fishing rights."
  },
  {
    word: "accost",
    type: "v.",
    definition: "to confront verbally",
    example: "When the waiter spilled soup on her, she stood up and accosted the man."
  },
  {
    word: "accretion",
    type: "n.",
  ...
  },
  {
    ...
    example: "Though he wanted to stay outside, he acquiesced to his wife's demands to come in for dinner."
  },
  {
    word: "acrimony",
    type: "n.",
    definition: "bitterness, discord",
    example: "Biff and Trevor could not keep acrimony from overwhelming their friendship after they both fell in love."
  },
  {
    word: "adroit",
    type: "adj.",
  ...
  },
  {
    word: "advocate",
    type: "v.",
    definition: "to argue in favor of something",
  ...
  },
  {
    ...
    example: "When his mother asked him to set the table he did so with alacrity."
  },
  {
    word: "alias",
    type: "n.",
  ...
  },
  {
    ...
    example: "The chairman of the Federal Reserve gave a speech to try to allay investors' fears."
  },
  {
    word: "allege",
    type: "v.",
    definition: "to assert, usually without proof",
    example: "The policeman had alleged that Marshall committed the crime, but Marshall was set free."
  },
  {
    word: "alleviate",
    type: "v.",
  ...
  },
  {
    ...
    example: "The scientist could sometimes seem aloof, as if he didn't care about his friends or family."
  },
  {
    word: "altercation",
    type: "n.",
  ...
  },
  {
    ...
    example: "The presidential candidate was able to amalgamate all democrats and republicans under his banner."
  }
];
